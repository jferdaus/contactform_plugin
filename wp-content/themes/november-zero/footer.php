...
?>
	...
	<div class="site-info">
			...
			<span class="sep"> | </span>
				 <?php  echo sprintf( esc_html__( 'Powered by %s', 'november-zero' ), '<a target="_blank" rel="designer" href="https://novemberthemes.com/">' . esc_html__( 'NovemberThemes', 'november-zero' ) . '</a>' ); ?> 
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
