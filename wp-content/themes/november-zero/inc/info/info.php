		...
		$config = array(
			...
			'quick_links' => array(
				'theme_url' => array(
					...
					'url'  => 'https://novemberthemes.com/downloads/november-lite',
					),
				'demo_url' => array(
					'text' => esc_html__( 'View Demo', 'november-zero' ),
					'url'  => 'https://novemberthemes.com/demo/november-zero/',
					),
				'documentation_url' => array(
					'text' => esc_html__( 'View Documentation', 'november-zero' ),
					'url'  => 'https://novemberthemes.com/doc/november-zero/',
					),
				'rating_url' => array(
			...
			'getting_started' => array(
				'one' => array(
					...
					'button_url'  => 'https://novemberthemes.com/doc/november-zero/',
					'button_type' => 'link',
					'is_new_tab'  => true,
					),
				'two' => array(
			...
			'support' => array(
				'one' => array(
					...
					'button_url'  => 'https://novemberthemes.com/contact/',
					'button_type' => 'link',
					'is_new_tab'  => true,
					),
				'two' => array(
			...
			'upgrade_to_pro' => array(
				...
				'button_url'  => 'https://novemberthemes.com/downloads/november-zero/',
				'button_type' => 'primary',
				'is_new_tab'  => true,
				),
			);
